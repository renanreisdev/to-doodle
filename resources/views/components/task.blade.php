...
<div data-task-id="{{ $data['id'] }}"
    ...
    <div class="flex items-center gap-3">
        <label class="w-5 h-5 border-2 border-secondary2 rounded-full cursor-pointer">
        </label>

        <input type="checkbox" class="hidden cursor-pointer" />

        <p class="text-base tracking-wider">{title}</p>
    </div>

    <div class="flex items-center gap-3 text-gray_td-300 text-sm tracking-wider">
        <div data-task-description-svg>
            <svg class="z-10 cursor-pointer hover:scale-125 transition-all ease-linear duration-200" width="23"
                height="24" viewBox="0 0 31 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path data-task-description
        ...
        @endif
        <div data-task-div-priority class="w-28 flex justify-end items-center gap-1">
            <p class="max-w-[80px] truncate">{priority-title]</p>
            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="10" cy="10" r="10" fill="#45A29E" />
            </svg>
        </div>

        <div data-task-div-category class="w-28 flex justify-end items-center gap-1">
            ...
            <svg width="24" height="24" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    ...
                    fill="#45A29E" />
                <rect x="0.5" y="0.5" width="33" height="33" rx="4.5" stroke="#45A29E" />
            </svg>
        </div>

        <div data-task-div-buttons class="w-28 flex justify-end items-center gap-5">
